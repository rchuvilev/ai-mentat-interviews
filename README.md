...
```sh
git clone --recurse-submodules https://github.com/hexstack-apps/ai-mentat-interviews.git
cd ai-mentat-interviews
...
| `build` | builds for the current OS into `/.hexstack-app/ai-mentat-interviews/ai-mentat-interviews.<ext>` |
...
Until then the app falls back to `~/.hexstack-app/ai-mentat-interviews/data` rather than
failing to start.
